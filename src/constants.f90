module constants
    ...
    real(r_kind), parameter :: starting_params(num_params) = [-15.465, 15.95866, 24.03928,0.0,0.71158,50.66491,3.69,0.22]
    ...
    integer, parameter :: Z_fit_minval = 8
    integer, parameter :: N_fit_minval = 8
